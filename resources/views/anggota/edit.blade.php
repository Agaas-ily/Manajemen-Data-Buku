@include('layout.header')
    ...
    <form action="{{ route('anggota.update', $anggota->id) }}" method="POST">
        ...
        @method('PUT')
        <div class="mb-4">
            <label  for="nama_anggota" class="block text-gray-700 font-bold mb-2">Nama Anggota</label> 
        ...
        <div class="mb-4">
            <label  for="no_telepon" class="block text-gray-700 font-bold mb-2">No Telepon</label> 
