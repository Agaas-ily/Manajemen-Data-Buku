@include('layout.header')
    <h3 class="font-bold mb-4 border-b pb-3 text-xl" style="text-align: center;">Daftar Anggota</h3>
    <div style="text-align: center;">
        <a href ="{{ route('anggota.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Tambah Anggota</a>
    </div>
    <table class="table_1">
        <thead>
            ...
            <tr>
                ...
                <td class="custom_td">
                    <form action="{{ route('anggota.destroy', $r->id) }}" method="POST">
                        <a href="{{ route('anggota.show', $r->id) }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">Detail</a>
                        <a href="{{ route('anggota.edit', $r->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">Edit</a>
                        @csrf
                        @method('DELETE')
